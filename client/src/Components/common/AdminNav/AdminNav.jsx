    ...
    <div className='admin__nav__container'>
      <div className="admin__nav__user">
        ...
        <div className={showDropdown ? 'admin__nav__dropdown active' : 'admin__nav__dropdown'}>
          {currentUser?.display_name && <p className='admin__nav__display__name'>{currentUser?.display_name}</p>}
          <p className='admin__nav__username'>{currentUser?.username}</p>
          <ul>
          <Link onClick={handleClick} className='admin__nav__link' to='/dashboard'><li><FiGrid />Dashboard</li></Link>
